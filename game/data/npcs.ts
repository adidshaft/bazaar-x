...
export const npcDefinitions: NpcDefinition[] = [
  ...
  },
  {
    ...
    shortBio: "Turns supply listings into routes, handoffs, and downstream labor.",
    dialogueId: "supplier",
    questHooks: ["open-depot", "hire-worker", "hire-supplier"],
    economyRole: "Stages fulfillment and hires worker routes.",
  },
  {
    id: "worker",
    name: "Node Pilot",
  ...
  },
  {
    ...
    shortBio: "Reads tax receipts as reserve state and approves reinvestment when the notice is real.",
